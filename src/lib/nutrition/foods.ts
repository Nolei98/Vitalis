...
import { kcalFromMacros } from './calc';

// Base curada de alimentos brasileiros (aprox. por 100g, estilo TACO).
// Built-in (em código); o banco guarda só os alimentos personalizados.
